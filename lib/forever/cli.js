...
var help = [
  ...
  '  tail <script|index> Tails the logs for <script|index> continuously (by JJR)',
...
app.cmd('tail :index', cli.tail = function (index) {
...
//  		console.log(proc);
		...
		tail = new Tail(proc.logFile);

		tail.on("line", function(data) {
	//	  forever.log.data(data);
		  console.log(data);
		});	
